...
const Auth0ProviderWithHistory = ({ children }) => {
  ...
  const onRedirectCallback = (appState) => {
    navigate(appState?.returnTo || window.location.pathname); // Navega a la ruta almacenada en appState o a la ruta actual
  };
...
export default Auth0ProviderWithHistory; // Exporta el componente Auth0ProviderWithHistory
